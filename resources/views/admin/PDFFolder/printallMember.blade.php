<!-- @extends('layout.layout') -->
 ...
 <head>
   ...
   @media print {
        tr.inactive {
            color: #F88379 !important; /* Light Red */
        }
        tr.active {
 ...
 <body style="padding: 32px;">
    ...
    <table style="width: 100%; border-collapse: collapse;">
        ...
        <section style="margin-bottom: 30px;">
            ...
            Legend: 
            <span style="display: inline-block; width: 10px; height: 10px; color: green; border-radius: 50%; margin-right: 5px; border: 2px solid green;"></span>
<span style="color: green; margin-right: 10px;">Active</span> / 
<span style="display: inline-block; width: 10px; height: 10px; color: red; border-radius: 50%; margin-right: 5px; border: 2px solid red;"></span>
<span style="color: red;">Inactive</span>
            ...
            <table style="width: 100%; border-collapse: collapse;">
    <thead>
    <table style="border-collapse: collapse; width: 100%; font-weight: bold; letter-spacing: 0.3px;">
    <tr>
    ...
    <tbody>
        ...
        <tr style="color: {{ e($member->member_status == 'inactive' ? 'red' : 'green') }};">
            <td style="padding: 2px; border-bottom: 1px solid black; font-size: 9px; width: 20%;">{{ $member->name }} {{ $member->last_name }}</td>
            <td style="padding: 2px; border-bottom: 1px solid black; font-size: 9px;">{{ $member->type }}</td>
            <td style="padding: 2px; border-bottom: 1px solid black; font-size: 9px; text-align: center;">
            ...
            <!-- <td style="padding: 2px; border-bottom: 1px solid black; font-size: 9px;">{{ $member->member_status }}</td> -->
            <td style="padding: 2px; border-bottom: 1px solid black; font-size: 9px; text-align: center">
            ...
            <td style="padding: 2px; border-bottom: 1px solid black; font-size: 9px;">
                @if ($member->vehicle->isEmpty() || !$member->owner)
                    Nonapplicable
                @else
            ...
            <td style="padding: 2px; border-bottom: 1px solid black; font-size: 9px; text-align: center">{{ $member->paid_payments_count }}</td>
            <td style="padding: 2px; border-bottom: 1px solid black; font-size: 9px; text-align: center">{{ $member->unpaid_payments_count }}</td>
            <td style="padding: 2px; border-bottom: 1px solid black; font-size: 9px;">{{ $member->current_month_status }}</td>
        </tr>
        @endforeach
    </tbody>
</table>
