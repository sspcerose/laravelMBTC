...
<div id="icon-sidebar"
    ...
    <div class="absolute w-16 h-full bg-neutral-200 flex flex-col items-center pt-10 space-y-5">
        <a href="{{ route('ForTesting.AdminHome') }}"
        ...
        <a href="{{ route('ForTesting.AdminBooking') }}"
            class="tab-link text-slate-900 hover:text-slate-400 transition-colors duration-300 flex items-center justify-center w-10 h-10 rounded-lg"
            data-tab="Booking">
            <i class="fas fa-calendar-alt fa-xl"></i> <!-- Booking -->
        </a>
        <a href="{{ route('ForTesting.DriverSchedule') }}"
            class="tab-link text-slate-900 hover:text-slate-400 transition-colors duration-300 flex items-center justify-center w-10 h-10 rounded-lg"
            data-tab="Schedule">
            <i class="fas fa-user-clock fa-xl"></i> <!-- Tarrifs -->
        </a>
        <a href="{{ route('ForTesting.AdminMembers') }}"
            class="tab-link text-slate-900 hover:text-slate-400 transition-colors duration-300 flex items-center justify-center w-10 h-10 rounded-lg"
            data-tab="Members">
            <i class="fas fa-users fa-xl"></i> <!-- Members -->
        </a>
        <a href="{{ route('ForTesting.AdminMonthlyDue') }}"
            class="tab-link text-slate-900 hover:text-slate-400 transition-colors duration-300 flex items-center justify-center w-10 h-10 rounded-lg"
            data-tab="Monthly Dues">
            <i class="fas fa-dollar-sign fa-xl"></i> <!-- Monthly Dues -->
        </a>
        <a href="{{ route('ForTesting.AdminTariff') }}"
            class="tab-link text-slate-900 hover:text-slate-400 transition-colors duration-300 flex items-center justify-center w-10 h-10 rounded-lg"
            data-tab="Tarrifs">
            <i class="fas fa-chart-bar fa-xl"></i> <!-- Tarrifs -->
        </a>
        <a href="{{ route('ForTesting.AdminVehicle') }}"
            class="tab-link text-slate-900 hover:text-slate-400 transition-colors duration-300 flex items-center justify-center w-10 h-10 rounded-lg"
            data-tab="Vehicle">
            <i class="fas fa-car fa-xl"></i> <!-- Vehicle -->
        </a>
        <!-- <a href="#"
            class="tab-link text-red-700 hover:text-red-400 transition-colors duration-300 flex items-center justify-center w-10 h-10 rounded-lg"
            data-tab="Logout">
            <i class="fas fa-sign-out-alt fa-xl"></i> Logout -->
        <!-- </a> -->
...
<div id="sidebar" class="fixed inset-y-0 left-0 z-40 bg-gray-800 bg-opacity-75 hidden transition-opacity duration-300" style="top: 4rem;">
    <div class="absolute text-xl font-semibold top-0 left-0 w-64 h-full bg-neutral-200 p-5">
        <ul class="mt-4 space-y-2">
            <li>
                <a href="{{ route('ForTesting.AdminHome') }}" class="tab-link text-slate-900 hover:text-slate-400 p-2 rounded-lg font-bold bg-slate-900 flex items-center" data-tab="Home">
                    <i class="fas fa-home mr-4 w-5"></i> Home
                </a> <!-- Set as active -->
            </li>
            <li>
                <a href="{{ route('ForTesting.AdminBooking') }}" class="tab-link block text-slate-900 hover:text-slate-400 p-2 rounded-lg font-bold flex items-center" data-tab="Booking">
                    <i class="fas fa-calendar-alt mr-4 w-5"></i> Booking
                </a>
            </li>
            <li>
                <a href="{{ route('ForTesting.DriverSchedule') }}" class="tab-link block text-slate-900 hover:text-slate-400 p-2 rounded-lg font-bold flex items-center" data-tab="Schedule">
                    <i class="fas fa-user-clock mr-4 w-5"></i> Driver's Schedule
                </a>
            </li>
            <li>
                <a href="{{ route('ForTesting.AdminMembers') }}" class="tab-link block text-slate-900 hover:text-slate-400 p-2 rounded-lg font-bold flex items-center" data-tab="Members">
                    <i class="fas fa-users mr-4 w-5"></i> Members
                </a>
            </li>
            <li>
                <a href="{{ route('ForTesting.AdminMonthlyDue') }}" class="tab-link block text-slate-900 hover:text-slate-400 p-2 rounded-lg font-bold flex items-center" data-tab="Monthly Dues">
                    <i class="fas fa-dollar-sign mr-4 w-5"></i> Monthly Dues
                </a>
            </li>
            <li>
                <a href="{{ route('ForTesting.AdminMonthlyDue') }}" class="tab-link block text-slate-900 hover:text-slate-400 p-2 rounded-lg font-bold flex items-center" data-tab="Tarrifs">
                    <i class="fas fa-chart-bar mr-4 w-5"></i> Tarrifs
                </a>
            </li>
            <li>
                <a href="{{ route('ForTesting.AdminTariff') }}" class="tab-link block text-slate-900 hover:text-slate-400 p-2 rounded-lg font-bold flex items-center" data-tab="Vehicle">
